...
import static com.freddiemac.datamanager.ws.constant.ModelConstants.DATA_TYPE_INT;
import static com.freddiemac.datamanager.ws.constant.ModelConstants.DATA_TYPE_REQUEST_METADATA_TYPE;
import static com.freddiemac.datamanager.ws.constant.ModelConstants.DATA_TYPE_STRING;
import static com.freddiemac.datamanager.ws.constant.ModelConstants.REQUEST_METADATA_DESCRIPTION;
import static com.freddiemac.datamanager.ws.constant.ModelConstants.REQUEST_RESPONSE_IDENTIFIER_EXAMPLE;
import static com.freddiemac.datamanager.ws.constant.ModelConstants.REQUEST_RESPONSE_IDENTIFIER_NAME;
import static com.freddiemac.datamanager.ws.constant.ModelConstants.REQUEST_RESPONSE_IDENTIFIER_NOTES;
import static com.freddiemac.datamanager.ws.constant.ModelConstants.REQUEST_RESPONSE_RECORD_COUNT_EXAMPLE;
import static com.freddiemac.datamanager.ws.constant.ModelConstants.REQUEST_RESPONSE_RECORD_COUNT_NAME;
import static com.freddiemac.datamanager.ws.constant.ModelConstants.REQUEST_RESPONSE_RECORD_COUNT_NOTES;
import static com.freddiemac.datamanager.ws.constant.ModelConstants.REQUEST_RESPONSE_SOURCE_SYSTEM_EXAMPLE;
import static com.freddiemac.datamanager.ws.constant.ModelConstants.REQUEST_RESPONSE_SOURCE_SYSTEM_NAME;
import static com.freddiemac.datamanager.ws.constant.ModelConstants.REQUEST_RESPONSE_SOURCE_SYSTEM_NOTES;
import static com.freddiemac.datamanager.ws.constant.ModelConstants.REQUEST_RESPONSE_TIMESTAMP_EXAMPLE;
import static com.freddiemac.datamanager.ws.constant.ModelConstants.REQUEST_RESPONSE_TIMESTAMP_NAME;
import static com.freddiemac.datamanager.ws.constant.ModelConstants.REQUEST_RESPONSE_TIMESTAMP_NOTES;
...
@ApiModel(value = DATA_TYPE_REQUEST_METADATA_TYPE, description = REQUEST_METADATA_DESCRIPTION)
@JsonPropertyOrder({REQUEST_RESPONSE_IDENTIFIER_NAME, REQUEST_RESPONSE_SOURCE_SYSTEM_NAME, REQUEST_RESPONSE_TIMESTAMP_NAME, REQUEST_RESPONSE_RECORD_COUNT_NAME})
